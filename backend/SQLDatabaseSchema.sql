...
CREATE TABLE accounts (
  ...
  accountEmail VARCHAR(320) NOT NULL UNIQUE,
  accountPassword VARCHAR(320) NOT NULL,
  
  accountFirstName VARCHAR(40) NOT NULL,
  accountLastName VARCHAR(40) NOT NULL,
  
  accountIsAdmin BOOLEAN NOT NULL DEFAULT FALSE,
